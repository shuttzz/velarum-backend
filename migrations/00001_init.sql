...
CREATE TABLE cities (
    ...
    era                  SMALLINT NOT NULL DEFAULT 1,
    matter_stored        NUMERIC(14,3) NOT NULL DEFAULT 0,
    energy_stored        NUMERIC(14,3) NOT NULL DEFAULT 0,
    knowledge_stored     NUMERIC(14,3) NOT NULL DEFAULT 0,
    matter_rate          NUMERIC(10,3) NOT NULL DEFAULT 0, -- por hora
    energy_rate          NUMERIC(10,3) NOT NULL DEFAULT 0,
    knowledge_rate       NUMERIC(10,3) NOT NULL DEFAULT 0,
    matter_cap           NUMERIC(14,3) NOT NULL DEFAULT 500,
    energy_cap           NUMERIC(14,3) NOT NULL DEFAULT 500,
    knowledge_cap        NUMERIC(14,3) NOT NULL DEFAULT 200,
