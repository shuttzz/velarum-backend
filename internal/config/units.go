...
type UnitDef struct {
	...
	GatherRate      float64          // taxa de COLETA por unidade (recurso/segundo) — modelo RoK por-tropa
	Era             int
}
...
// Carga/Taxa: encher a carga cheia leva ~constante (carga÷taxa = 50s p/ ambos); um exército maior
// drena um nó PEQUENO mais rápido (taxa total = Σ taxa por tropa). Cf. config/nodes.go (CollectPlan).
var Era1Units = []UnitDef{
	{Key: "lanceiro", Name: "Lanceiro", Category: "infantry", Attack: 10, Defense: 8, HP: 30, Move: 1, Range: 1, Cost: resource.Amounts{Matter: 20, Energy: 10}, RecruitTime: 10, MinBarracksLevel: 1, Carry: 25, GatherRate: 0.5, Era: 1},
	{Key: "arqueiro", Name: "Arqueiro", Category: "projectile", Attack: 14, Defense: 4, HP: 20, Move: 1, Range: 2, Cost: resource.Amounts{Matter: 15, Energy: 15}, RecruitTime: 15, MinBarracksLevel: 2, Carry: 20, GatherRate: 0.4, Era: 1},
}
