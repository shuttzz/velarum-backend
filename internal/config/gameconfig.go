...
var Era1Buildings = []BuildingDef{
	...
	{Key: "torre_do_vigia", Name: "Torre do Vigia", Category: "defense", BaseCost: resource.Amounts{Matter: 90, Energy: 30, Knowledge: 10}, BaseTime: 45, MaxCopies: 1, Era: 1, Requires: []Requirement{{"canteiro_de_almas", 1}}, Implemented: true},
	{Key: "muralha", Name: "Muralha", Category: "defense", BaseCost: resource.Amounts{Matter: 120, Energy: 40}, BaseTime: 40, MaxCopies: 1, Era: 1, Implemented: true},
	{Key: "toca_dos_batedores", Name: "Toca dos Batedores", Category: "military", BaseCost: resource.Amounts{Matter: 80, Energy: 60, Knowledge: 20}, BaseTime: 30, MaxCopies: 1, Era: 1, Implemented: true},
